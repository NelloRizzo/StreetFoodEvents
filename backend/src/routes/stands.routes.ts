...
standsRouter.patch('/:standId/sync-password', asyncHandler(authMiddleware), asyncHandler(hasRole(['platform-admin', 'event-admin'])), asyncHandler(setStandSyncPassword));
