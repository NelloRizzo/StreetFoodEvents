# CHANGELOG ANNUALE — Street Food Events

Storico completo delle feature implementate prima del mese corrente.
Questo file NON viene piu aggiornato: le nuove voci vanno in CHANGELOG.md (mese corrente).
