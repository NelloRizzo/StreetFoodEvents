    ...
    const bodyJson = {
      ...
      location: {
        ...
        coordinates: form.latitude && form.longitude
          ...
          : null,
        googleMapsUrl: (urlEditMode ? form.googleMapsUrl : autoGeneratedUrl) || null,
      },
            ...
            <fieldset className={styles.fieldset}>
              ...
              <div className={styles.field}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                  <input
                    id="ev-maps"
                    value={urlEditMode ? form.googleMapsUrl : autoGeneratedUrl}
                  ...
                  {urlEditMode ? (
                    ...
                    <button type="button" className={styles.textBtn} onClick={() => { setForm({ ...form, googleMapsUrl: autoGeneratedUrl }); setUrlEditMode(true) }}>
                      ✏️ Modifica
                    </button>
                  )}
                  <a
                    href={urlEditMode ? form.googleMapsUrl : autoGeneratedUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.textBtn}
                    style={{ textDecoration: 'none' }}
                    onClick={(e) => {
                      const url = urlEditMode ? form.googleMapsUrl : autoGeneratedUrl
